...
import { presetFor, indexConfigs, materialize } from "../dist/build.js";
import { atomic, hash } from "../dist/common.js";
export const cliPath = process.env.SRCX_TEST_CLI ?? resolve("dist/cli.js");
const packageVersion = JSON.parse(
  await readFile("package.json", "utf8"),
).version;

export async function cliContract(t, preset) {
