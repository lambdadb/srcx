...
| Syntax | Java and TypeScript/JavaScript; chunking v2 adds Python/Go, while other text uses recorded fallback |
...
The v2 implementation adds Python/Go using the existing pinned WASM grammars.
...
These rules do not change Java/TypeScript/JavaScript boundaries. Version 1 remains
supported for existing Collections and builds, with Python/Go text fallback.
New registrations use v2 identities; upgrading requires a separate Collection and
full import, not an in-place rewrite of immutable evidence.
